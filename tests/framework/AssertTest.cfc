...
<cfcomponent  extends="mxunit.framework.TestCase">
	...
	<cffunction name="whenAssertEqualsFailsForStringsExpectedAndActualValuesShouldBePopulated">
		<cftry>
			...
			<cfcatch type="mxunit.exception.AssertionFailedError">
				<cfset assertEquals("Please Excuse me sir",this.getExpected()) />
				<cfset assertEquals("Please Excuse me madam",this.getActual()) />
			</cfcatch>
		</cftry>
	</cffunction>
	...
	<cffunction name="whenAssertEqualsPassesExpectedAndActualValuesShouldBeEmpty">
		...
		<cfset assertTrue(this.getExpected() eq "","this.expected should have been empty but was #this.getExpected()#") />
		<cfset assertTrue(this.getActual() eq "", "this.actual should have been empty but was #this.getActual()#") />
	</cffunction>
